    ...
    <div className="settings-about">
      <div className="settings-about__card">
        ...
        <div className="settings-about__branding">
          <img width="60" height="60" src={CinnySVG} alt="Drop logo" />
          <div>
            <Text variant="h2" weight="medium">
              Drop Chat
              <span className="text text-b3" style={{ margin: '0 var(--sp-extra-tight)' }}>{`v${cons.version}`}</span>
            </Text>
            <Text>The matrix client that makes it easy for you.</Text>

            <div className="settings-about__btns">
              <Button onClick={() => window.open('https://github.com/drop-org/drop')}>Source code</Button>
              <Button onClick={() => window.open('mailto:drop@dglobal.dev')}>Support</Button>
            </div>
          </div>
        </div>
      </div>
      <div className="settings-about__card">
        ...
        <div className="settings-about__credits">
          ...
          <li>
              ...
              <Text><a href="https://github.com/cinnyapp/cinny" rel="noreferrer noopener" target="_blank">Cinny</a> is © <a href="https://matrix.org/foundation" rel="noreferrer noopener" target="_blank">Ajay Bura (ajbura)</a> used under the terms of <a href="https://github.com/cinnyapp/cinny/blob/dev/LICENSE" rel="noreferrer noopener" target="_blank">MIT License</a>.</Text>
            </li>
            <li>
              {/* eslint-disable-next-line react/jsx-one-expression-per-line */ }
